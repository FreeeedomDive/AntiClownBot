@echo off
cd ../k8s
kubectl apply -f anticlown-data-api-postgresql-job.yaml
kubectl apply -f anticlown-api-postgresql-job.yaml
kubectl apply -f anticlown-entertainment-api-postgresql-job.yaml
kubectl apply -f anticlown-discord-bot-postgresql-job.yaml
kubectl apply -f anticlown-data-api-deployment.yaml
...
kubectl apply -f anticlown-web-front-deployment.yaml
