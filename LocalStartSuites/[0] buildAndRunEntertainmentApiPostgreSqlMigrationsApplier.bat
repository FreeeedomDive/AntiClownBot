@echo off
cd ..
docker build src -f src/EntertainmentApi/AntiClown.Entertainment.Api.PostgreSqlMigrationsApplier/Dockerfile -t localhost:5000/anticlownentertainmentapipostgresql
