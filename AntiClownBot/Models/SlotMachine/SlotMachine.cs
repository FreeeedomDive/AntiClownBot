    ...
    public class SlotMachine
    {
        ...
        public static readonly CircularReel[] CircularReels = {
            new(new CellSeries(11, AllCells[0]),
                new CellSeries(16, AllCells[1]),
                new CellSeries(9, AllCells[2]),
                new CellSeries(6, AllCells[3]),
                new CellSeries(4, AllCells[4]),
                new CellSeries(2, AllCells[5]),
                new CellSeries(2, AllCells[6]),
                new CellSeries(4, AllCells[7])),
            new(new CellSeries(11, AllCells[0]),
                new CellSeries(16, AllCells[1]),
                new CellSeries(9, AllCells[2]),
                new CellSeries(7, AllCells[3]),
                new CellSeries(4, AllCells[4]),
                new CellSeries(2, AllCells[5]),
                new CellSeries(2, AllCells[6]),
                new CellSeries(5, AllCells[7])),
            new(new CellSeries(17, AllCells[0]),
                new CellSeries(12, AllCells[1]),
                new CellSeries(7, AllCells[2]),
                new CellSeries(3, AllCells[3]),
                new CellSeries(6, AllCells[4]),
                new CellSeries(2, AllCells[5]),
                new CellSeries(2, AllCells[6]),
                new CellSeries(6, AllCells[7]))
        };
