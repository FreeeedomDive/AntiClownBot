    ...
    public class UserStatsCommand : BaseCommand
    {
        ...
        public override async void Execute(MessageCreateEventArgs e, SocialRatingUser user)
        {
            ...
            stringBuilder
                ...
                .Append($"Шанс уменьшить подготовка подношение : {Constants.CooldownDecreaseChanceByOneGigabyte + user.Stats.CooldownDecreaseChanceExtend}% {user.Stats.CooldownDecreaseTryCount} раз на {Constants.CooldownDecreaseByOneGigabyteItem}%\n")
                .Append($"Шанс увеличить подготовка подношение : {Constants.CooldownIncreaseChanceByOneJade + user.Stats.CooldownIncreaseChanceExtend}% {user.Stats.CooldownIncreaseTryCount} раз на {Constants.CooldownIncreaseByOneJade}%\n")
